...
if (mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] != UPLOAD_ERR_NO_FILE) {
            ...
            $query = "UPDATE user SET Lastname = '$lastname', Firstname = '$firstname', Middlename = '$midname', course = '$course', year_level = '$year_level' WHERE username = '$username'";
    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="idno" name="idno" class="form-control" 
                value="<?php echo htmlspecialchars($user['idnumber']); ?>" readonly>
        </div>
